...
\author{Mengmeng Li, Changyou Chen, Chen Cai}  % 修改为你想显示的作者名

\iclrfinalcopy  % 启用最终版本模式，显示作者名而非 "Anonymous authors"
