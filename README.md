...
export DEEPSEEK_API_KEY="sk-e4b5b1f350664a60adaf0e3875489717"

export GLM_API_KEY="49121a0ad40043399bb557f6fd5752bf.BADVwad1NK2P3ZIt"

python launch_scientist.py --model "glm-4.7" --experiment steering_parameter_identification --num-ideas 2 --skip-novelty-check --skip-idea-generation

  方式 2：复制图片到 latex 目录后重新编译
  cd results/steering_parameter_identification/20260111_220815_attention_parameter_identification
  cp *.png latex/
  cd latex
